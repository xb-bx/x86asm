...
cmove_r16_r16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Reg16) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmove %s, %s", dest, src)) }
...
cmove_m32 :: proc(using assembler: ^Assembler, dest: Reg32, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmove %s, dword %s", dest, src)) }
...
cmove_m64 :: proc(using assembler: ^Assembler, dest: Reg64, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmove %s, qword %s", dest, src)) }
...
cmove_m16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmove %s, word %s", dest, src)) }
...
cmovge_r16_r16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Reg16) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovge %s, %s", dest, src)) }
...
cmovge_m32 :: proc(using assembler: ^Assembler, dest: Reg32, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovge %s, dword %s", dest, src)) }
...
cmovge_m64 :: proc(using assembler: ^Assembler, dest: Reg64, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovge %s, qword %s", dest, src)) }
...
cmovge_m16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovge %s, word %s", dest, src)) }
...
cmovg_r16_r16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Reg16) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovg %s, %s", dest, src)) }
...
cmovg_m32 :: proc(using assembler: ^Assembler, dest: Reg32, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovg %s, dword %s", dest, src)) }
...
cmovg_m64 :: proc(using assembler: ^Assembler, dest: Reg64, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovg %s, qword %s", dest, src)) }
...
cmovg_m16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovg %s, word %s", dest, src)) }
...
cmovle_r16_r16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Reg16) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovle %s, %s", dest, src)) }
...
cmovle_m32 :: proc(using assembler: ^Assembler, dest: Reg32, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovle %s, dword %s", dest, src)) }
...
cmovle_m64 :: proc(using assembler: ^Assembler, dest: Reg64, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovle %s, qword %s", dest, src)) }
...
cmovle_m16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovle %s, word %s", dest, src)) }
...
cmovl_r16_r16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Reg16) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovl %s, %s", dest, src)) }
...
cmovl_m32 :: proc(using assembler: ^Assembler, dest: Reg32, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovl %s, dword %s", dest, src)) }
...
cmovl_m64 :: proc(using assembler: ^Assembler, dest: Reg64, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovl %s, qword %s", dest, src)) }
...
cmovl_m16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovl %s, word %s", dest, src)) }
...
cmovne_r16_r16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Reg16) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovne %s, %s", dest, src)) }
...
cmovne_m32 :: proc(using assembler: ^Assembler, dest: Reg32, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovne %s, dword %s", dest, src)) }
...
cmovne_m64 :: proc(using assembler: ^Assembler, dest: Reg64, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovne %s, qword %s", dest, src)) }
...
cmovne_m16 :: proc(using assembler: ^Assembler, dest: Reg16, src: Memory) {
    if mnemonics != nil { append(&mnemonics, fmt.aprintf("cmovne %s, word %s", dest, src)) }
